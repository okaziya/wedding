      ...
      <div className="max-w-4xl mx-auto">
        ...
        <article className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-lg mb-8">
          ...
          <p className="text-lg mb-6">
            Today we completed a series of updates that makes the wedding event app installable on your Android/iPhone home screen. Please see setup instructions for{' '}
            <a 
