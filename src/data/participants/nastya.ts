...
export const nastyaDetails: ParticipantDetails = {
  ...
  welcomeMessage: "Welcome, Nastya and Family! We are so thrilled to welcome my dear sister Nastya, her husband Kostya, and their wonderful children Vika and Sema to our wedding! thank you for crossing the Baltic Sea for us! We look forward to see you and show you around one of our favorite places in Sweden. Hopefully, this will be the first of many visits in the future.",
