...
export const janneDetails: ParticipantDetails = {
  ...
  description: "Mats' father Janne and Ann-Katrin lives 45 minutes west of Sundsvall in Attmarby village, they have two horses, cats and a lot of houses. They like to do repairs their houses, care for the horses, and engage in crafting.",
  welcomeMessage: "Very welcome, Janne and Ann-Katrin! Thank you for joining our ceremony in Siljansnäs, it means a lot to have our close families gathered for the event.",
