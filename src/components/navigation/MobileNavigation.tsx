...
const MenuIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M9.25 5C9.25 4.58579 9.58579 4.25 10 4.25H20C20.4142 4.25 20.75 4.58579 20.75 5C20.75 5.41421 20.4142 5.75 20 5.75H10C9.58579 5.75 9.25 5.41421 9.25 5Z"
      fill="#B14B57"
    />
    <path
    ...
    />
    <path
      d="M4 18.25C3.58579 18.25 3.25 18.5858 3.25 19C3.25 19.4142 3.58579 19.75 4 19.75H14C14.4142 19.75 14.75 19.4142 14.75 19C14.75 18.5858 14.4142 18.25 14 18.25H4Z"
      fill="#B14B57"
    />
  </svg>
);
