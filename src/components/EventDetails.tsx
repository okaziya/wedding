  ...
  return (
    <section className="py-20 bg-wedding-primary/20" id="details">
      <div className="container mx-auto px-4">
        <h2 className="font-merriweather text-4xl md:text-5xl text-center mb-12 text-wedding-accent">Event Details</h2>
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="animate-fade-in bg-white">
            <div className="p-6">
              <h3 className="font-satisfy text-2xl mb-4 text-wedding-accent">Reception</h3>
          ...
          <Card className="animate-fade-in bg-white">
            <div className="p-6">
              <h3 className="font-satisfy text-2xl mb-4 text-wedding-accent">Ceremony</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <Clock className="w-5 h-5 mr-2 text-wedding-secondary" />
